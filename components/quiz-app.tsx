  ...
  const handleCheckAnswer = () => {
    ...
    const isCorrect =
      currentQuestion.type === "single"
        ...
        : currentQuestion.correctAnswer.every((ans) => userAnswer.includes(ans)) &&
          ...
          <div className="space-y-6">
            ...
            <div className="bg-emerald-50 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm text-gray-700">
                <li>The quiz contains multiple-choice and single-choice questions</li>
                <li>Questions and options will be randomly ordered each time</li>
    ...
    <div className="space-y-4">
      {reviewMode && (
        <div className="bg-blue-100 text-blue-800 p-3 rounded-lg mb-4 text-center">
          <p className="font-medium">Review Mode: Navigate through questions to see your answers</p>
        </div>
      )}
